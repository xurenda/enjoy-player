<template>
  <div class="ml-2 mt-2 box-border flex-1 overflow-y-auto pr-2">
    ...
    >
      <NestedMenu v-model:open-keys="openKeys" :data="videoListStore.categoryTree" itemKey="type_id">
        <template #default="{ item, level }">
          <div
            :class="{ active: item.type_id === videoListStore.curCategory }"
            ...
            @click="videoListStore.curCategory = item.type_id"
          >
